        ...
        <Wrapper>
            ...
            <section className="contact-hero text-white position-relative">
                ...
                <div className="container position-relative text-center py-5">
                    <motion.h1 className="display-4 bricolage-grotesque fw-bold mb-3" initial={{ opacity: 0, y: -40 }} animate={{ opacity: 1, y: 0 }} >
                        Connect & Collaborate
                    </motion.h1>

                    <motion.p className="lead mulish" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} >
                ...
                <div className="container">
                                ...
                                <form>
                                    <div className="row g-3">
                                        <div className="col-md-6">
                                            <input type="text" className="form-control form-control-lg rounded-4" placeholder="Your Name" />
                                        </div>

                                        <div className="col-md-6">
                                            <input type="email" className="form-control form-control-lg rounded-4" placeholder="Your Email" />
                                        </div>
                                    </div>

                                    <div className="mt-4 mb-4">
                                        <textarea className="form-control form-control-lg rounded-4" rows="6" placeholder="Your Message"></textarea>
                                    </div>
                    ...
                    <div className="row mt-5">
                        <div className="col-12">
                            <div className="card card-jazz overflow-hidden" style={{ height: "400px" }} >
                                <iframe
