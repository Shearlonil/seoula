        ...
        <Wrapper>
            ...
            <section className="hero-wrapper position-relative text-white overflow-hidden">
                ...
                <div className="container position-relative py-5 hero-content">
                    ...
                    <motion.p className="lead mulish mb-4 text-center text-lg-start" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}
                    >
            ...
            <section className="py-5 bg-light">
                <div className="container text-center">
                    <motion.h2 className="display-5 bricolage-grotesque mb-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} >
                        The Journey
                    </motion.h2>
                    <motion.p className="lead mulish mb-3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} >
                        Born under city lights and raised on vinyl crackle, SE'OULA
                        discovered jazz at 12 in a hidden underground club.
                    </motion.p>
                    <motion.p className="mulish fs-5 mb-3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} >
                    ...
                    <motion.p className="mulish fs-5" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} >
            ...
            <section className="py-5 bg-white">
                <div className="container">
                    ...
                    <div className="row g-4 justify-content-center">
                        {timeline.map((item, i) => (
                            <motion.div key={i} className="col-md-6 col-lg-3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.2 }} >
                                ...
                                >
                                    <div className={`position-absolute top-0 start-0 w-100 h-3 bg-${item.color}`}></div>
                                    <div className="card-body text-center pt-5">
                                        <div className={`d-inline-flex align-items-center justify-content-center rounded-circle mb-4 text-white bg-${item.color}`}
                                            style={{
                                                width: "90px",
                                                height: "90px",
                                                fontSize: "2rem",
            ...
            <section className="py-5 bg-light">
                <div className="container">
                    ...
                    <div className="row g-4 justify-content-center">
                        {albums.map((album, i) => (
                            <motion.div key={i} className="col-sm-6 col-md-3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 * i }} >
                ...
                <div className="container">
                    ...
                    <div className="row g-3 justify-content-center">
                        {galleryImages.map((img, i) => (
                            <motion.div key={i} className="col-6 col-sm-4 col-md-3" whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }} >
                                <img src={img} alt={`Gallery ${i}`} className="img-fluid rounded-4 shadow-sm gallery-image" />
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            {/*  */}
            <section className="py-5 text-white text-center" style={{ background: "#6366f1" }} >
                ...
                <div className="container m-4 m-auto">
                    <blockquote className="display-5 container bricolage-grotesque fw-light">
                        "SE'OULA's music changed my life. Every note feels like a story from the soul."
                    </blockquote>
                </div>
            ...
            <section className="py-5 bg-light text-center">
                ...
                <div className="d-flex justify-content-center gap-2 flex-wrap">
                  <input type="email" placeholder="Your email" className="form-control w-auto"
                      style={{
                          maxWidth: "300px",
                          borderRadius: "30px",
                          padding: "10px 15px",
