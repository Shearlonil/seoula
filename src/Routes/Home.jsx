...
const Home = () => {
    return (
        <>
            {/* HERO SECTION */}
            <section className="text-white d-flex align-items-center"
                style={{
                    minHeight: "100vh",
                  ...
                  <div className="container py-5 position-relative" style={{ zIndex: 5 }}>
                      <div className="row align-items-center justify-content-between">
                          <div className="col-lg-6">
                              <h1 className="display-1 fw-bold bricolage-grotesque mb-4">
                                  SE'OULA
                              </h1>
                              <p className="lead fs-4 mulish mb-4 text-light">
                                  Se'oula was conceived with the admiration and love for the classical guitar.
                              ...
                              <p className="lead fs-4 mulish mb-4 text-light">
                                However, the blend of Traditional Jazz, Contemporary Jazz, Classical and movie sound tracks for the entertainment industry is also a passionate area of 
                                interest.
                              </p>
                          ...
                          <div className="col-lg-5 text-center mt-4 mt-lg-0">
                              <div className="p-2 shadow-lg rounded-4"
                                  style={{
                                      background: "rgba(255,255,255,0.1)",
                                      backdropFilter: "blur(10px)",
                                  }}
                              >
                                  <img src={IMAGES.image2} alt="Hero" className="img-fluid rounded-4" />
                              </div>
                          </div>
                      </div>
                  </div>
                ...
                <div className="container">
                    ...
                    <div className="row g-4">
                        <div className="col-md-4">
                          <div className="p-4 rounded-4 shadow" style={{ background: "rgba(255,255,255,0.05)" }}>
                              ...
                              <p className="mulish text-light">
                                  A curated selection of authentic jazz rhythms with a modern twist.
                              </p>
                          </div>
                        </div>
                        ...
                        <div className="col-md-4">
                            <div className="p-4 rounded-4 shadow" style={{ background: "rgba(255,255,255,0.05)" }}>
                                ...
                                <p className="mulish text-light">
                                    High–quality audio designed to pull you deeper into the rhythm.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4">
                          <div className="p-4 rounded-4 shadow" style={{ background: "rgba(255,255,255,0.05)" }}>
                              ...
                              <p className="mulish text-light">
                                  Experience jazz in a way that's elegant, bold, and unforgettable.
                              </p>
                          </div>
                        </div>
                    </div>
            ...
            <section className="py-5 text-white" style={{ background: "#1e1b4b" }}>
                <div className="container">
                    <div className="row align-items-center g-4">
                        <div className="col-lg-6">
                            <img src="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4" alt="artist" className="img-fluid rounded-4 shadow-lg"/>
                        </div>
            ...
            {/* NEWSLETTER */}
            <section className="py-5 text-center text-white" style={{ background: "#312e81" }}>
                <div className="container">
                    <h3 className="bricolage-grotesque mb-3">
                        Stay Connected with SE'OULA
                    </h3>
                    <p className="mulish mb-4">
                        Get new releases, updates, and exclusive content straight to your inbox.
                    </p>
